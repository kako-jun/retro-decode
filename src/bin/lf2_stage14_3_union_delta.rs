...
//!
//! 新規6variant (Basic/NoDummy/Fill00 × ClosestDist/FarthestDist) を
//! 522本全件に適用し、既存 union257 (`.local_data/stage12_18/union_all.txt`)
//! への純増を求める。
...
use retro_decode::formats::toheart::okumura_lzss::{
    compress_okumura_basic_eof_closest_tie, compress_okumura_basic_eof_farthest_tie,
    compress_okumura_fill00_eof_closest_tie, compress_okumura_fill00_eof_farthest_tie,
    compress_okumura_no_dummy_eof_closest_tie, compress_okumura_no_dummy_eof_farthest_tie, Token,
};

fn variants() -> Vec<(&'static str, fn(&[u8]) -> Vec<Token>)> {
    vec![
        ("basic_eof_closest_tie", compress_okumura_basic_eof_closest_tie),
        ("no_dummy_eof_closest_tie", compress_okumura_no_dummy_eof_closest_tie),
        ("fill00_eof_closest_tie", compress_okumura_fill00_eof_closest_tie),
        ("basic_eof_farthest_tie", compress_okumura_basic_eof_farthest_tie),
        ("no_dummy_eof_farthest_tie", compress_okumura_no_dummy_eof_farthest_tie),
        ("fill00_eof_farthest_tie", compress_okumura_fill00_eof_farthest_tie),
    ]
}
...
fn main() {
    ...
    println!("net NEW files (not already in union257): {}", net_new.len());
